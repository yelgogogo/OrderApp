...
Ext.Loader.addClassPathMappings({
  ...
  "Ext.cmd": "../../../C:/Users/Administrator/bin/Sencha/Cmd/6.1.3.42/plugins/src",
  ...
  "MyFirst": "app",
  "app.util.Proxy": "app/util/Proxy.js"
});
...
Ext.ClassManager.addNameAlternateMappings({
  ...
  "MyFirst.controller.Login": [],
  "MyFirst.controller.Order": [],
  "MyFirst.model.Good": [],
  "MyFirst.model.GoodsDetail": [],
  "MyFirst.model.GoodsType": [],
  "MyFirst.model.Order": [],
  "MyFirst.model.OverView": [],
  "MyFirst.model.Rights": [],
  "MyFirst.model.Room": [],
  "MyFirst.model.User": [],
  "MyFirst.store.CancelOrders": [],
  "MyFirst.store.Goods": [],
  "MyFirst.store.GoodsDetails": [],
  "MyFirst.store.GoodsTypes": [],
  "MyFirst.store.Orderings": [],
  "MyFirst.store.Orders": [],
  "MyFirst.store.OverViews": [],
  "MyFirst.store.Rooms": [],
  "MyFirst.store.User": [],
  "MyFirst.view.Card": [],
  "MyFirst.view.Detail": [],
  "MyFirst.view.Info": [],
  "MyFirst.view.List": [],
  "MyFirst.view.ListCustomerOrders": [],
  "MyFirst.view.ListGoods": [],
  "MyFirst.view.ListGoodsDetail": [],
  "MyFirst.view.ListGoodsType": [],
  "MyFirst.view.ListOrdered": [],
  "MyFirst.view.ListOrderings": [],
  "MyFirst.view.ListOrders": [],
  "MyFirst.view.ListOverView": [],
  "MyFirst.view.ListTpl": [],
  "MyFirst.view.LoginForm": [],
  "MyFirst.view.MainView": [],
  "MyFirst.view.MngCard": [],
  "MyFirst.view.PosForm": [],
...
Ext.ClassManager.addNameAliasMappings({
  ...
  "MyFirst.view.ListCustomerOrders": [
    "widget.customerorders",
    "widget.customerorderslist"
  ],
  "MyFirst.view.ListGoods": [
    "widget.goods",
    "widget.goodslist"
  ...
  "MyFirst.view.ListGoodsType": [
    "widget.goodstypelist",
    "widget.goodstypes"
  ],
  "MyFirst.view.ListOrdered": [
    "widget.orderedgoods",
    "widget.orderedgoodslist"
  ],
  "MyFirst.view.ListOrderings": [
    "widget.orderings",
    "widget.orderingslist"
  ],
  "MyFirst.view.ListOrders": [
    "widget.ordereds",
    "widget.orderedslist"
