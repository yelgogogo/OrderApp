...
Ext.Loader.addClassPathMappings({
  ...
  "app.util.CustomerProxy": "app/util/CustomerProxy.js"
});

Ext.ClassManager.addNameAlternateMappings({
  "CustomerApp.controller.Customer": [],
  "CustomerApp.model.Good": [],
  "CustomerApp.model.GoodsDetail": [],
  "CustomerApp.model.GoodsType": [],
  "CustomerApp.model.Order": [],
  "CustomerApp.store.Goods": [],
  "CustomerApp.store.GoodsDetails": [],
  "CustomerApp.store.GoodsTypes": [],
  "CustomerApp.store.Orderings": [],
  "CustomerApp.store.Orders": [],
  "CustomerApp.view.CustMainForm": [],
  "CustomerApp.view.ListGoods": [],
  "CustomerApp.view.ListGoodsDetail": [],
  "CustomerApp.view.ListGoodsType": [],
  "CustomerApp.view.ListOrderings": [],
  "CustomerApp.view.ListOrders": [],
  "CustomerApp.view.ListTpl": [],
